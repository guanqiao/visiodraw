...
export const defaultConnectionPointsConfig: Record<string, ConnectionPointPosition[]> = {
  ...
  'uml-fragment-break': ['top', 'bottom', 'left', 'right'],
  'uml-fragment-critical': ['top', 'bottom', 'left', 'right'],
  'uml-fragment-strict': ['top', 'bottom', 'left', 'right'],
  'uml-fragment-seq': ['top', 'bottom', 'left', 'right'],
  'uml-fragment-ignore': ['top', 'bottom', 'left', 'right'],
  'uml-fragment-consider': ['top', 'bottom', 'left', 'right'],
  'uml-fragment-assert': ['top', 'bottom', 'left', 'right'],
  'uml-fragment-neg': ['top', 'bottom', 'left', 'right'],
  'uml-signal-send': ['top', 'bottom', 'left', 'right'],
  'uml-signal-receive': ['top', 'bottom', 'left', 'right'],
  'uml-flow-final': ['top', 'bottom', 'left', 'right'],
  'uml-state-history': ['top', 'bottom', 'left', 'right'],
  'uml-state-deep-history': ['top', 'bottom', 'left', 'right'],
  'uml-state-entry-point': ['top', 'bottom', 'left', 'right'],
  'uml-state-exit-point': ['top', 'bottom', 'left', 'right'],
  'uml-state-terminate': ['top', 'bottom', 'left', 'right'],
  'uml-connector': [],
  'uml-timing-ruler': ['left', 'right'],
  'uml-timing-state-line': ['top', 'bottom', 'left', 'right'],
  'uml-timing-event': ['top', 'bottom'],
  'uml-timing-duration': ['left', 'right'],
  'uml-timing-constraint': ['top', 'bottom', 'left', 'right'],
  'uml-object-instance': ['top', 'bottom', 'left', 'right'],
  'uml-link': [],
  'uml-link-end': ['top', 'bottom', 'left', 'right'],
  'uml-comm-object': ['top', 'bottom', 'left', 'right'],
  'uml-comm-link': [],
  'uml-comm-message': [],
  'uml-comm-reverse-message': [],
